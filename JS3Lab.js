 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
const str = "alphabetString";

const letters = str.split('abcdefghijklmnopqrstuvwxyz');
...
//console.log(elements.join(alphabetArray));
...
myTodoList.push ('laundry','dishes','cooking');
console.log(myTodoList);

myTodoList.splice(1,1);
console.log(myTodoList);

var yourTodoList = ['homework','cleaning']
